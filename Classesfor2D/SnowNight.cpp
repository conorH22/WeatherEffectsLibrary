...
bool SnowNight::init()
{
	...
	auto titleSprite = Sprite::create("nightSnow.png");//image
	...
	auto closeItem = MenuItemImage::create(
		"CloseNormal.png",
		"CloseSelected.png",
		CC_CALLBACK_1(SnowNight::menuCloseCallback, this));
    ...
    float scale = winSize.width / 320.0f;//320x480 particle effect. Scaling
...
void SnowNight::menuCloseCallback(Ref* pSender)
{
